...
export default function ECEProgramPage({
  onOpenApplyModal,
  onOpenLoginModal,
  onNavigateHome
}: ECEProgramPageProps) {
  ...
  return (
    <div id="ece-program-page" className="w-full bg-[#FFFFFF] text-[#1A1A1A] font-sans antialiased selection:bg-[#8C1515]/20">
      ...
      <div className="bg-[#FAF8F5] border-b border-[#E5E0D5] py-2.5 px-4 sm:px-6 lg:px-12">
        <div className="max-w-[1400px] mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-2 text-xs font-mono tracking-wider text-[#777]">
            ...
            <span>/</span>
            <span className="text-[#8C1515] font-bold">Electronics & Communication Engineering</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative z-20">
            ...
            <div className="lg:col-span-8 pr-0 lg:pr-6">
              ...
              <div className="inline-block bg-[#F1EFEA] text-[#555] text-[11px] sm:text-xs font-medium px-3 py-1 rounded-md mb-4 border border-[#E2DDD5]">
                Study Electronics and Communication Engineering in Bangalore
              </div>
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-[42px] font-black tracking-tight text-[#111] leading-[1.12] mb-5">
                ...
                <span className="text-[#8C1515] font-black">Electronics &amp; Communication</span>{" "}
                <span className="text-[#111] font-bold">&amp; Engineering</span>
              </h1>

              {/* Paragraph */}
              <p className="text-[14px] sm:text-[15px] text-[#444] leading-[1.65] mb-4 max-w-2xl font-normal">
                Are you searching for a top Electronics and Communication Engineering college in Bangalore? HKBK College of Engineering offers industry-focused ECE programs with expert faculty, modern labs, and excellent placements.
              </p>

              {/* Tagline / Subtitle */}
              <div className="text-sm sm:text-base font-bold text-[#111] mb-6">
                &ldquo;Where Knowledge Meets Innovation&rdquo;
              </div>
            ...
            <div className="lg:col-span-4 relative z-30 lg:-mb-36">
              ...
              <div className="absolute -inset-3 sm:-inset-5 -top-6 -bottom-8 rounded-[28px] overflow-hidden -z-10 shadow-2xl pointer-events-none">
                ...
                >
                  <defs>
                    <linearGradient id="eceScallopGrad1" x1="0%" y1="0%" x2="100%" y2="100%">
                    ...
                    <linearGradient id="eceScallopGrad2" x1="100%" y1="0%" x2="0%" y2="100%">
                    ...
                    <filter id="eceSoftGlow" x="-20%" y="-20%" width="140%" height="140%">
                  ...
                  <path
                    d="M120,0 
                       ...
                       L400,600 L400,0 Z"
                    fill="url(#eceScallopGrad1)"
                    filter="url(#eceSoftGlow)"
                  />
                ...
                {formSubmitted ? (
                  <div className="p-5 bg-emerald-50 border border-emerald-200 rounded-lg text-center space-y-3">
                    ...
                    <p className="text-xs text-emerald-700 leading-relaxed">
                      Thank you <span className="font-semibold">{formData.name}</span>. Our ECE admissions team will reach out at <span className="font-semibold">{formData.phone}</span> shortly.
                    </p>
                    <button
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                      ...
                      <select
                        ...
                        className="w-full text-[11px] font-medium px-2.5 py-2 rounded border border-[#CCC] focus:border-[#E01A22] focus:outline-none bg-white text-[#666] cursor-pointer"
                      >
                        <option value="B.E. Electronics & Communication Engineering">SELECT PROGRAM</option>
                        <option value="B.E. Electronics & Communication Engineering">B.E. Electronics &amp; Comm. Engg</option>
        ...
        <div className="relative w-full mt-4 sm:mt-6">
          ...
          <div className="relative w-full h-[360px] sm:h-[420px] lg:h-[480px] bg-slate-900 overflow-hidden">
            ...
            <img
              ...
              alt="Electronics and Communication Engineering Student at HKBK Campus"
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 max-w-4xl">
                  ...
                  <div className="bg-white rounded-lg p-3 sm:p-3.5 flex items-center shadow-md border border-white/60">
                    <p className="text-[9.5px] sm:text-[10.5px] text-[#444] leading-tight">
                      B.E. Electronics &amp; Communication Engineering Program is approved by the Statutory Apex Body <span className="text-[#8C1515] font-semibold underline">AICTE</span>, Ministry of Education, Govt. of India.
                    </p>
                  </div>
                  ...
                  <div className="bg-white rounded-lg p-3 sm:p-3.5 flex items-center shadow-md border border-white/60">
                    <p className="text-[9.5px] sm:text-[10.5px] text-[#444] leading-tight">
                      B.E. Electronics &amp; Communication Engineering Program is permanently affiliated to <span className="text-[#8C1515] font-semibold underline">VTU</span> Belagavi, approved by Govt. of Karnataka.
                    </p>
                  </div>
        ...
        <div className="w-full bg-[#8C1515] border-t border-[#721111] text-white py-5 sm:py-6 shadow-md relative z-20">
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 lg:gap-0 lg:divide-x lg:divide-white/20">
              ...
              <div className="flex flex-col items-center text-center px-3 sm:px-4 col-span-2 md:col-span-1">
                <div className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center mb-2 shrink-0 border border-white/20">
                  <Sparkles className="w-4 h-4 text-white" />
                </div>
                <span className="text-[11px] font-mono font-semibold uppercase tracking-wider text-white/75 block mb-2">
                  Extra Electives
                </span>
                <div className="flex flex-wrap items-center justify-center gap-1.5 max-w-[280px]">
                  <span className="text-[10px] font-semibold bg-white/15 text-white border border-white/20 px-2 py-0.5 rounded">
      ...
      {/* 5. Program Overview Section (Matching Reference Image Layout & Content) */}
      <section id="ece-program-overview" className="w-full bg-[#FAF8F5] border-b border-[#E5E0D5] py-14 sm:py-20 lg:py-24">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12">
          
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-0 items-stretch">
            
            {/* Left Column: Program Context & Legacy */}
            <div className="lg:col-span-6 lg:pr-12 xl:pr-16 flex flex-col justify-between">
              <div>
                <h2 className="text-2xl sm:text-3xl lg:text-[38px] font-extrabold text-[#111111] tracking-tight leading-[1.18] mb-6">
                  Best Electronics and Communication Engineering College in Bangalore, India
                </h2>

                <div className="space-y-4 text-[14.5px] sm:text-[15.5px] text-[#444] leading-[1.7] font-normal">
                  <p>
                    If you are looking for the best Electronics and Communication Engineering college in Bangalore, HKBKCE&apos;s Department of Electronics and Communication Engineering offers a world-class UG programme designed to shape tomorrow&apos;s engineers.
                  </p>
                  <p>
                    The Department offers a full-time UG programme in Electronics &amp; Communication Engineering, established in 1997 with an initial intake of 45 students, and has since grown into one of the most resourceful departments in the institution, with a current intake of 180 students. As a leading B.Tech/B.E ECE college in Bangalore, the programme is affiliated to Visvesvaraya Technological University (VTU), Belagavi and approved by the All India Council for Technical Education (AICTE). The UG programme is also accredited by the National Board of Accreditation (NBA), New Delhi, till 2026, a distinction that sets us apart as one of the top Electronics and Communication Engineering colleges in Bangalore.
                  </p>
                </div>
              </div>
            ...
            {/* Right Column: About the Program & World-Class Infrastructure */}
            <div className="lg:col-span-5 lg:pl-4 xl:pl-6 flex flex-col justify-start">
              ...
              <div className="space-y-4 text-[14.5px] sm:text-[15.5px] text-[#444] leading-[1.7] font-normal">
                <p>
                  The Department is headed by <strong className="text-[#111] font-semibold">Dr. Manjunath R Kounte</strong> and supported by <strong className="text-[#111] font-semibold">35+ qualified and experienced faculty members</strong> with expertise in VLSI and embedded systems, digital communication, signal processing, computer networks, and nanoelectronics — faculty for whom teaching is truly a passion.
                </p>

                <div className="pt-2">
                  <h4 className="text-base sm:text-lg font-bold text-[#111111] tracking-tight mb-2">
                    World-Class Infrastructure &amp; Labs
                  </h4>
                  <p className="mb-3">
                    As one of the top ECE colleges in Bangalore, HKBKCE boasts well-equipped laboratories supported by industry-standard software tools including:
                  </p>
                  <div className="p-3.5 bg-white rounded-lg border border-[#E5E0D5] text-[13px] sm:text-[13.5px] text-[#333] font-medium leading-relaxed mb-3 shadow-2xs">
                    <span className="text-[#8C1515] font-bold block mb-1 uppercase tracking-wider text-[11px] font-mono">Software Tools:</span>
                    MATLAB, LabVIEW, Cadence, Electric 9.07, Xilinx, ModelSim, Multisim, Keil, Flash Magic, PSpice, NCTuns 4.0, CCStudio, and more.
                  </div>
                  <p>
                    Hardware support includes <strong className="text-[#111] font-semibold">LPC, ALS SDK 51, ALS B30DRV, SPARTAN6, and XC6SIX4 boards</strong>, ensuring students receive practical, industry-relevant training.
                  </p>
                </div>
              </div>
      ...
      {/* 6. Scope Section (Pixel-Perfect Match to Reference Image Layout) */}
      <section id="ece-scope" className="relative w-full bg-white overflow-hidden pt-12 sm:pt-16 lg:pt-20">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 relative z-20">
          
          {/* Main Maroon Card (Scope Details & Recruiters) */}
          <div className="max-w-4xl lg:max-w-5xl bg-[#8C1515] text-white rounded-3xl p-6 sm:p-10 lg:p-12 shadow-[0_20px_50px_rgba(140,21,21,0.35)] relative z-20 border border-[#A31D1D]/30">
            ...
            {/* Scope Narrative */}
            <div className="space-y-3.5 text-xs sm:text-[14.5px] text-white/90 leading-[1.65] font-normal mb-7 max-w-3xl">
              <p>
                One of the strongest reasons students choose HKBKCE is our exceptional placement record.
              </p>
              <p>
                As an ECE college with best placements in Bangalore, our graduates are recruited by leading organizations across both government and private sectors.
              </p>
            </div>

            {/* Government Sector Recruiters Header */}
            <div className="mb-6">
              <h3 className="text-sm sm:text-[15px] font-bold text-white uppercase tracking-wider mb-3 flex items-center space-x-2">
                <span>Government Sector Recruiters:</span>
              </h3>
              
              {/* Government Sector Recruiters Grid */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-3.5 bg-black/15 p-4 sm:p-5 rounded-2xl border border-white/15">
                {[
                  { org: "ISRO", full: "Indian Space Research Organization" },
                  { org: "ECIL", full: "Electronics Corporation of India Limited" },
                  { org: "BARC", full: "Bhabha Atomic Research Centre" },
                  { org: "DRDO", full: "Defence Research and Development Organization" },
                  { org: "BEL", full: "Bharat Electronics Limited" },
                  { org: "DERL", full: "Defence Electronics and Research Laboratory" },
                  { org: "BHEL", full: "Bharat Heavy Electricals Limited" },
                  { org: "HAL", full: "Hindustan Aeronautics Limited" },
                  { org: "Railway Departments", full: "Signalling & Telecom" },
                ].map((item, idx) => (
                  <div key={idx} className="flex items-start space-x-2.5">
                    <div className="w-4 h-4 rounded-[4px] bg-white flex items-center justify-center shrink-0 mt-0.5 shadow-xs">
                      <Check className="w-3 h-3 text-[#8C1515] stroke-[3]" />
                    </div>
                    <div className="min-w-0">
                      <strong className="text-[12.5px] sm:text-[13px] font-bold text-white block leading-tight">
                        {item.org}
                      </strong>
                      <span className="text-[10.5px] sm:text-[11px] text-white/80 block leading-tight">
                        {item.full}
                      </span>
                    </div>
                  </div>
            ...
            {/* Private Sector Recruiters Header */}
            <div className="pt-2">
              <h3 className="text-sm sm:text-[15px] font-bold text-white uppercase tracking-wider mb-3">
                Private Sector Recruiters:
              </h3>

              {/* Private Sector Recruiters Grid with White Checkmarks */}
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-4 sm:gap-x-6 gap-y-3">
                {[
                  ...
                  <div key={company} className="flex items-center space-x-2.5 group">
                    <div className="w-4 h-4 rounded-[4px] bg-white flex items-center justify-center shrink-0 shadow-xs">
                      <Check className="w-3 h-3 text-[#8C1515] stroke-[3]" />
                    </div>
                    <span className="text-[12px] sm:text-[13px] font-semibold text-white tracking-tight">
                      {company}
                    </span>
                  </div>
                ))}
        ...
        {/* Full-width Background Photo of Students Collaborating & Floating Apply CTA */}
        <div className="relative w-full -mt-24 sm:-mt-32 lg:-mt-48 h-[400px] sm:h-[480px] lg:h-[560px] bg-slate-900 overflow-hidden">
          <img
            ...
            alt="ECE Students Collaborating in Modern Lab"
      ...
      {/* 7. Eligibility and Fees Details (Exact Match to Reference Layout & Content) */}
      <section id="ece-eligibility-fees" className="w-full bg-[#FAF8F5] border-b border-[#E5E0D5] py-14 sm:py-20 lg:py-24">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
          ...
          <div className="max-w-4xl mb-8 sm:mb-10">
            <h2 className="text-2xl sm:text-3xl lg:text-[34px] font-black text-[#111111] tracking-tight leading-[1.2] mb-3">
              HKBKCE Electronics &amp; Communication Engineering Eligibility &amp; Fee Details
            </h2>
            <p className="text-[14px] sm:text-[15.5px] text-[#555] leading-[1.7]">
              As one of the top electronics and communication engineering colleges in Bangalore, HKBKCE maintains clear and transparent admission criteria to ensure the right candidates join this prestigious program.
            </p>
          </div>

          {/* Academic Eligibility Requirements Box (Matching reference with red dot bullet & inner relaxation card) */}
          <div className="bg-white rounded-2xl sm:rounded-3xl border border-[#E5E0D5] p-6 sm:p-8 lg:p-9 mb-12 shadow-xs">
            
            {/* Header with Red Dot */}
            <div className="flex items-center space-x-2.5 mb-4">
              <span className="w-2.5 h-2.5 rounded-full bg-[#8C1515] shrink-0 inline-block" />
              <h3 className="text-base sm:text-lg font-bold text-[#111111] tracking-tight">
                Academic Eligibility Requirements
              </h3>
            </div>
            
            {/* Main Criteria Paragraph */}
            <p className="text-xs sm:text-[14px] text-[#333333] leading-[1.75] mb-5">
              Candidates must have passed Second PUC / 12th Standard / 10+2 / A Level / IB / American 12th Grade or an equivalent qualification, with English as one of the subjects, and a minimum aggregate of <strong className="text-[#111111] font-bold">45% marks in Physics and Mathematics</strong>, along with any one of the following: Chemistry / Bio-Technology / Biology / Electronics / Computer Science.
            </p>

            {/* Inner Highlight Box: Karnataka Candidate Relaxation */}
            <div className="p-4 sm:p-5 bg-[#FAF8F5]/80 rounded-xl border border-[#E5E0D5] mb-5">
              <p className="text-xs sm:text-[13.5px] text-[#444444] leading-relaxed">
                <strong className="text-[#8C1515] font-bold">Karnataka Candidate Relaxation:</strong> SC, ST, Category 1, 2A, 2B, 3A, and 3B candidates from Karnataka State are eligible with a minimum aggregate of <strong className="text-[#111111] font-bold">40%</strong>. This relaxation applies exclusively to Karnataka candidates.
              </p>
            </div>

            {/* Entrance Examination Footer */}
            <p className="text-xs sm:text-[13.5px] text-[#333333]">
              <strong className="text-[#111111] font-bold">Entrance Examination:</strong> Admission is processed through JEE / KCET or any other recognized engineering entrance examination.
            </p>

          </div>

          {/* Detailed Fee Structure Header & Interactive Tabs Switcher */}
          <div className="mb-8">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 pb-2">
              <div>
                <h3 className="text-xl sm:text-2xl font-black text-[#111111] tracking-tight mb-1">
              ...
              {/* Tabs Switcher Pill */}
              <div className="inline-flex bg-[#EFECE6] p-1 rounded-xl border border-[#E0DBD1] self-start sm:self-auto shrink-0">
                <button
                  onClick={() => setFeeCategory("indian")}
                  className={`px-4 sm:px-5 py-2 rounded-lg text-xs sm:text-[13px] font-bold transition-all cursor-pointer ${
                    feeCategory === "indian"
          ...
          {/* Fee Tables View (Indian or International) */}
          {feeCategory === "indian" ? (
            <div className="space-y-8">
              
              {/* Single-line Summary Table (Matching Reference Top Mini-Table) */}
              <div className="max-w-2xl overflow-hidden rounded-xl border border-[#D5D0C5] shadow-xs">
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-[#4A5568] text-white text-[11px] sm:text-xs uppercase tracking-wider font-bold">
                  ...
                  <tbody className="divide-y divide-[#E5E0D5] bg-white text-xs sm:text-sm text-[#222]">
                    <tr>
                      ...
                      <td className="py-3.5 px-4 sm:px-6 font-bold text-[#8C1515] border-r border-[#E5E0D5] whitespace-nowrap">₹ 7,10,000</td>
              ...
              {/* Detailed Year-by-Year Table (Matching Reference Slate Table Header) */}
              <div className="bg-white rounded-2xl border border-[#E5E0D5] overflow-hidden shadow-xs">
                <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-[#4A5568] text-white text-xs sm:text-[13px] font-bold uppercase tracking-wider border-b border-[#3F4D63]">
                        <th className="py-3.5 px-4 sm:px-6">Year</th>
                        <th className="py-3.5 px-4 sm:px-6">Tution Fee (Rs.)</th>
                        <th className="py-3.5 px-4 sm:px-6">University &amp; Extra fees</th>
                        <th className="py-3.5 px-4 sm:px-6">Total (Rs.)</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-[#E5E0D5] text-xs sm:text-sm text-[#222]">
                      <tr className="hover:bg-[#FAF8F5]/60 transition-colors">
                        <td className="py-3.5 px-4 sm:px-6 font-bold text-[#111]">1</td>
                        <td className="py-3.5 px-4 sm:px-6 font-medium text-[#444]">1,80,000</td>
                        <td className="py-3.5 px-4 sm:px-6 font-medium text-[#444]">20,000</td>
                        <td className="py-3.5 px-4 sm:px-6 font-bold text-[#8C1515]">2,00,000</td>
                      </tr>
                      <tr className="hover:bg-[#FAF8F5]/60 transition-colors">
                        <td className="py-3.5 px-4 sm:px-6 font-bold text-[#111]">2</td>
                        <td className="py-3.5 px-4 sm:px-6 font-medium text-[#444]">1,50,000</td>
                        <td className="py-3.5 px-4 sm:px-6 font-medium text-[#444]">20,000</td>
                        <td className="py-3.5 px-4 sm:px-6 font-bold text-[#8C1515]">1,70,000</td>
                      </tr>
                      <tr className="hover:bg-[#FAF8F5]/60 transition-colors">
                        <td className="py-3.5 px-4 sm:px-6 font-bold text-[#111]">3</td>
                        <td className="py-3.5 px-4 sm:px-6 font-medium text-[#444]">1,50,000</td>
                        <td className="py-3.5 px-4 sm:px-6 font-medium text-[#444]">20,000</td>
                        <td className="py-3.5 px-4 sm:px-6 font-bold text-[#8C1515]">1,70,000</td>
                      </tr>
                      <tr className="hover:bg-[#FAF8F5]/60 transition-colors">
                        <td className="py-3.5 px-4 sm:px-6 font-bold text-[#111]">4</td>
                        <td className="py-3.5 px-4 sm:px-6 font-medium text-[#444]">1,50,000</td>
                        <td className="py-3.5 px-4 sm:px-6 font-medium text-[#444]">20,000</td>
                        <td className="py-3.5 px-4 sm:px-6 font-bold text-[#8C1515]">1,70,000</td>
                      </tr>
                      <tr className="bg-[#FAF8F5] font-black border-t-2 border-[#8C1515]">
                        <td className="py-4 px-4 sm:px-6 text-xs sm:text-sm font-black text-[#111]">Total</td>
                        <td className="py-4 px-4 sm:px-6 text-xs sm:text-sm font-black text-[#111]">630,000</td>
                        <td className="py-4 px-4 sm:px-6 text-xs sm:text-sm font-black text-[#111]">80,000</td>
                        <td className="py-4 px-4 sm:px-6 text-xs sm:text-sm font-black text-[#8C1515]">710,000</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <div className="space-y-8">
              ...
              {/* Single-line Summary Table (International) */}
              <div className="max-w-2xl overflow-hidden rounded-xl border border-[#D5D0C5] shadow-xs">
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-[#4A5568] text-white text-[11px] sm:text-xs uppercase tracking-wider font-bold">
              ...
              {/* Detailed Year-by-Year Table (International) */}
              <div className="bg-white rounded-2xl border border-[#E5E0D5] overflow-hidden shadow-xs">
                <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-[#4A5568] text-white text-xs sm:text-[13px] font-bold uppercase tracking-wider border-b border-[#3F4D63]">
                        <th className="py-3.5 px-4 sm:px-6">Year</th>
                        <th className="py-3.5 px-4 sm:px-6">Tuition Fee ($)</th>
                        <th className="py-3.5 px-4 sm:px-6">University &amp; Extra Fees</th>
                    ...
                    <tbody className="divide-y divide-[#E5E0D5] text-xs sm:text-sm text-[#222]">
                      <tr className="hover:bg-[#FAF8F5]/60 transition-colors">
                        <td className="py-3.5 px-4 sm:px-6 font-bold text-[#111]">1</td>
                        <td className="py-3.5 px-4 sm:px-6 font-medium text-[#444]">$4,000</td>
                        <td className="py-3.5 px-4 sm:px-6 font-medium text-[#444]">$250</td>
                        <td className="py-3.5 px-4 sm:px-6 font-bold text-[#8C1515]">$4,250</td>
                      </tr>
                      <tr className="hover:bg-[#FAF8F5]/60 transition-colors">
                        <td className="py-3.5 px-4 sm:px-6 font-bold text-[#111]">2</td>
                        <td className="py-3.5 px-4 sm:px-6 font-medium text-[#444]">$3,000</td>
                        <td className="py-3.5 px-4 sm:px-6 font-medium text-[#444]">$250</td>
                        <td className="py-3.5 px-4 sm:px-6 font-bold text-[#8C1515]">$3,250</td>
                      </tr>
                      <tr className="hover:bg-[#FAF8F5]/60 transition-colors">
                        <td className="py-3.5 px-4 sm:px-6 font-bold text-[#111]">3</td>
                        <td className="py-3.5 px-4 sm:px-6 font-medium text-[#444]">$3,000</td>
                      ...
                      <tr className="bg-[#FAF8F5] font-black border-t-2 border-[#8C1515]">
                        <td className="py-4 px-4 sm:px-6 text-xs sm:text-sm font-black text-[#111]">Total</td>
                        <td className="py-4 px-4 sm:px-6 text-xs sm:text-sm font-black text-[#111]">13,000</td>
                        <td className="py-4 px-4 sm:px-6 text-xs sm:text-sm font-black text-[#111]">1,000</td>
                        <td className="py-4 px-4 sm:px-6 text-xs sm:text-sm font-black text-[#8C1515]">14,000</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          {/* Bottom Table Action & Note (Exact Match to Reference Image) */}
          <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-2">
            <p className="text-xs sm:text-[13px] text-[#666666] italic">
              * Scholarships &amp; merit concessions available for meritorious students and KCET high rankers.
            </p>

            <button
              onClick={onOpenApplyModal}
              className="bg-[#8C1515] hover:bg-[#9B2329] text-white font-bold text-xs sm:text-sm uppercase tracking-wider px-6 sm:px-8 py-3 rounded-lg flex items-center space-x-2.5 transition-all shadow-[0_4px_14px_rgba(140,21,21,0.25)] hover:shadow-[0_6px_18px_rgba(140,21,21,0.35)] active:scale-95 cursor-pointer self-stretch sm:self-auto justify-center"
            >
      ...
      <section id="ece-mou" className="w-full bg-[#FAF8F5] border-b border-[#E5E0D5] py-14 sm:py-20 lg:py-24 overflow-hidden">
      ...
      <section id="ece-who-is-it-for" className="w-full bg-[#F5F2EC] border-b border-[#E5E0D5] py-14 sm:py-20 lg:py-24">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 items-stretch">
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl border border-[#E5E0D5] p-7 sm:p-9 shadow-xs hover:shadow-md transition-shadow flex flex-col justify-start">
              ...
              <p className="text-[14.5px] sm:text-[15.5px] text-[#333333] leading-[1.75] font-normal">
                curious about electronics, circuits, and communication systems, with strong analytical and problem-solving skills. You have an interest in how signals, devices, and networks work together, enjoy hands-on experimentation, and are suited to a demanding, technically rigorous academic environment.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl border border-[#E5E0D5] p-7 sm:p-9 shadow-xs hover:shadow-md transition-shadow flex flex-col justify-start">
              ...
              <p className="text-[14.5px] sm:text-[15.5px] text-[#333333] leading-[1.75] font-normal">
                a rigorous, hands-on B.Tech/B.E. programme that builds strong fundamentals in electronics and communication engineering. You want to understand not just how circuits and systems work, but how to design, analyze, and apply them across real-world communication and embedded technologies.
              </p>
            </div>

            {/* Column 3: To Specialize In */}
            <div className="bg-white rounded-2xl sm:rounded-3xl border border-[#E5E0D5] p-7 sm:p-9 shadow-xs hover:shadow-md transition-shadow flex flex-col justify-start">
              <h3 className="text-xs sm:text-[13.5px] font-black uppercase tracking-wider text-[#111111] mb-5 sm:mb-6">
                TO SPECIALIZE IN...
              </h3>
              <ul className="space-y-2.5 sm:space-y-3 text-[14px] sm:text-[15px] text-[#333333] leading-relaxed">
                {[
                  "Embedded Systems",
                  "VLSI Design",
      ...
      {/* 10. Placement Stats Section (Matching CSE Red Banner Layout) */}
      <section id="ece-placement-stats" className="w-full bg-[#8C1515] text-white py-14 sm:py-16 lg:py-20">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
      ...
      {/* 12. Hiring From Us Section */}
      <section id="ece-hiring-partners" className="w-full bg-[#FAF8F5] border-b border-[#E5E0D5] py-14 sm:py-20 lg:py-24 overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 mb-8 sm:mb-12">
          <div className="max-w-3xl">
            ...
            <p className="text-[14px] sm:text-[15.5px] text-[#555] leading-[1.7] mt-3">
              Leading global semiconductor giants, electronics manufacturers, core public sector defense organizations, and tech leaders recruit engineering talent directly from HKBK Electronics &amp; Communication Engineering.
            </p>
          </div>
        </div>
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="animate-marquee-slow flex items-center space-x-12 sm:space-x-20 whitespace-nowrap">
                {[
                  ...
                  { name: "Texas Instruments", logo: "https://upload.wikimedia.org/wikipedia/commons/0/05/Texas_Instruments_logo.svg", h: "h-6 sm:h-7" },
                  { name: "Philips", logo: "https://upload.wikimedia.org/wikipedia/commons/d/df/Philips_logo_new.svg", h: "h-5 sm:h-6" },
                  { name: "HP", logo: "https://upload.wikimedia.org/wikipedia/commons/a/ad/HP_logo_2012.svg", h: "h-6 sm:h-7" },
                  ...
                  { name: "HCL", logo: "https://upload.wikimedia.org/wikipedia/commons/9/95/HCL_Technologies_logo.svg", h: "h-5 sm:h-6" },
                  ...
                  <div key={`ece-row1-${c.name}-${idx}`} className="flex items-center justify-center shrink-0 px-2 group cursor-pointer">
                    <img
                      src={c.logo}
                      alt={c.name}
                      referrerPolicy="no-referrer"
              ...
              <div className="animate-marquee-right flex items-center space-x-12 sm:space-x-20 whitespace-nowrap">
                {[
                  ...
                  { name: "Qualcomm", logo: "https://upload.wikimedia.org/wikipedia/commons/7/77/Qualcomm-Logo.svg", h: "h-6 sm:h-7" },
                  { name: "Broadcom", logo: "https://upload.wikimedia.org/wikipedia/commons/a/a0/Broadcom-Logo.svg", h: "h-6 sm:h-7" },
                  ...
                  <div key={`ece-row2-${c.name}-${idx}`} className="flex items-center justify-center shrink-0 px-2 group cursor-pointer">
                    <img
                      src={c.logo}
                      alt={c.name}
                      referrerPolicy="no-referrer"
      ...
      {/* 13. Every Journey Has a Story */}
      <section id="ece-student-stories" className="w-full relative overflow-hidden py-16 sm:py-24 lg:py-28 bg-[#111111]">
      ...
      {/* 14. FAQs Section */}
      <section id="ece-faqs" className="w-full bg-[#FAF8F5] border-b border-[#E5E0D5] py-16 sm:py-24 lg:py-28">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
          ...
          <div className="max-w-3xl mb-12 sm:mb-16">
            ...
            <p className="text-[14px] sm:text-[16px] text-[#555] leading-[1.7]">
              Get detailed, transparent answers regarding our B.E. Artificial Intelligence and Machine Learning / Electronics &amp; Communication technology programmes, academic eligibility, intake, and 2026 admissions.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  answer: "The B.E. Artificial Intelligence and Machine Learning programme at HKBK College of Engineering, Bengaluru, focuses on building foundations in computing, AI, machine learning and data-driven technologies. The department was established in the 2021–22 academic year and its intake increased from 60 to 120 for 2024–25."
                },
                {
                  id: "faq-aiml-2",
                  index: "02",
                  question: "What will I study in AI and Machine Learning at HKBK College of Engineering?",
                  answer: "Students study computing and AI-related areas including programming, data structures, operating systems, machine learning, neural networks and natural language processing, along with mathematics and other engineering subjects prescribed in the curriculum. The programme combines theoretical concepts with experimental and application-oriented learning."
                },
                {
                  id: "faq-aiml-3",
                  index: "03",
                ...
                },
                {
                  ...
                  answer: "AI & ML graduates can explore roles such as AI/ML Engineer, Data Scientist, Data Analyst, NLP Engineer, Computer Vision Engineer, Deep Learning Researcher, AI Product Manager, Robotics Engineer, Business Intelligence Analyst and AI Solutions Architect."
                },
                {
                  id: "faq-aiml-5",
                  index: "05",
                  question: "Does HKBK CE provide practical exposure to Artificial Intelligence and Machine Learning?",
                  answer: "Yes. HKBK CE states that the programme is designed around theoretical concepts and experimental learning in AI, machine learning and allied fields. The department also conducts activities around applied AI topics; for example, its listed events include an expert session on productionising machine-learning models."
                },
                {
                  id: "faq-aiml-6",
                  index: "06",
                  question: "Which companies are listed as recruiters for AI & ML students at HKBK CE?",
                  answer: "HKBK CE's AI & ML programme page lists companies including Adobe, Amazon, Google, Nokia, IBM, Juspay and NTT Data in its recruitment section. Actual placement opportunities depend on recruitment cycles, student eligibility, skills and company requirements."
                }
              ].map((faq, idx) => {
            ...
            <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-24">
              ...
              <div className="bg-white rounded-2xl border border-[#E5E0D5] p-6 sm:p-7 shadow-xs">
                ...
                <h3 className="text-lg font-bold text-[#111] mb-2">
                  Have Questions on ECE / AI?
                </h3>
                <p className="text-xs sm:text-[13.5px] text-[#666] leading-relaxed mb-6">
                  Speak directly with our academic counselors regarding ECE &amp; AI branch specializations, lateral entry, fee structures, or hostel facilities.
                </p>
                ...
                <div className="space-y-3">
                  ...
                  >
                    <span>Apply for ECE 2026 Batch</span>
                    <ArrowRight className="w-4 h-4" />
                  </button>
